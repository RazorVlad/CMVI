...
public class Newton {//����� �������(�����������)
    ...
    public Newton(Expression z, double[] a, double[] b, ResourceBundle bundle) {
        this.z = z;
        this.bundle = bundle;
        newton = printMethodName();
        //+"������ ���������,� ������� ��������� ������ �����"
        newton += bundle.getString("report.definedRootIntervals")
                + ":</h2>";
    ...
    public Newton(Expression z,ResourceBundle bundle) {
        this.z = z;
        newton = printMethodName();
        //+"������� ��������� � ������� ��������� �����:";
        newton += bundle.getString("report.searchRootIntervals");
        findAB();
    }
